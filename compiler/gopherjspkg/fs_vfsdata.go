...
var FS = func() http.FileSystem {
	fs := vfsgen۰FS{
		"/": &vfsgen۰DirInfo{
			name:    "/",
			modTime: time.Date(2023, 8, 28, 13, 47, 33, 31000000, time.UTC),
		},
		"/js": &vfsgen۰DirInfo{
			name:    "js",
			modTime: time.Date(2023, 8, 28, 13, 47, 33, 29000000, time.UTC),
		},
		...
		"/js/js_test.go": &vfsgen۰CompressedFileInfo{
			name:             "js_test.go",
			modTime:          time.Date(2023, 8, 28, 13, 43, 39, 584000000, time.UTC),
